          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                const SizedBox(width: 16),
                _GameCard(title: 'Rogue.IT', subtitle: 'Daily platformer', icon: Icons.castle, color: theme.absent, onTap: onRogueIT),
              ],
            ),
            const SizedBox(height: 48),
            Row(
